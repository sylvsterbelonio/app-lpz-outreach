...
<div class="content">
    <div class="row">
        <div class="col-lg-6">    
            ...
            <div class="card mt-4">
                <div class="card-body">
                    <h5 class="card-title" align=center>Mobile Android Apps</h5>
                    <div class="row">
                        <div class="col-lg-6">   
        ...
        <div class="col-lg-6">
            <div class="card mt-4">
                <div class="card-body">
                    <h5 class="card-title">Download Android Apps</h5>
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-6">    
                                <div class="row">
                                    <div class="col-lg-6">  
                                        <p>Release Version 1.0 <i>(April 24, 2023)</i></p>
                                    </div>   
                                    <div class="col-lg-6">  
                                        <p><a href="<?=base_url()?>assets/upload/app-downloads/g12-lpz-app-release_1_0.apk"> Download</p>
                                    </div>   
                                </div>
