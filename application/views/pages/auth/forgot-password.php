              ...
              <div class="card mb-3">
                ...
                <div id="contentForgotPassword" class="card-body">
                  ...
                  <div class="col-12">
                      ...
                      <input id="txt<?=$input['key-email']?>" type="text" name="<?=$input['email']?>" class="form-control" id="your<?=$input['key-email']?>" required>
                      <div id="feedback_<?=$input['key-email']?>" class="text-danger "></div>
                    </div>
